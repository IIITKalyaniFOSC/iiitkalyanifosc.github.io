...
function changetext(){
	...
	var language = [{"resultstring": colorstring(colour[indexcolor],"cout<<\"") + message +colorstring(colour[indexcolor],"\";")},
					{"resultstring": colorstring(colour[indexcolor],"System.out.println(\"") + message +colorstring(colour[indexcolor],"\");")},
					{"resultstring": colorstring(colour[indexcolor],"echo \"") + message +colorstring(colour[indexcolor],"\"")}
				   ];
